    ...
    <ImageBackground
         ...
         */}
           ...
           <View style={{marginTop:5,padding:10, marginLeft:20}}>
                <Text style={{fontSize:scaleSize (50), fontFamily: 'Blinker-Light', color:'#000'}}>A Classic</Text>
                <Text style={{fontSize:scaleSize (50), fontFamily: 'Blinker-Light', color:'#000'}}>That Loved</Text>
                <Text style={{fontSize:scaleSize (50), fontFamily: 'Blinker-Light', color:'#000'}}>By All</Text>
              </View>
